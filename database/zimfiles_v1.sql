...
-- Dumping data for table zimfiles.directors: ~8 rows (approximately)
DELETE FROM `directors`;
/*!40000 ALTER TABLE `directors` DISABLE KEYS */;
INSERT INTO `directors` (`id`, `user_id`, `nas_dir`, `vps_dir`, `created_at`, `updated_at`, `level`, `parent_id`, `path`, `type`, `status`, `editor_id`, `note`) VALUES
	(12, 1, 'dir_03092021', '-', '2021-09-03 09:31:26', '2021-09-03 09:31:26', 1, 0, '[]', 1, 1, NULL, NULL),
	(15, 1, 'expert', '-', '2021-09-03 09:42:25', '2021-10-06 04:05:43', 2, 12, NULL, 1, 4, 5, NULL),
	(16, 1, 'expert', '-', '2021-09-16 07:26:22', '2021-09-16 07:26:22', 1, 0, NULL, 1, 1, NULL, NULL),
	(17, 1, 'expert', '-', '2021-09-16 07:28:32', '2021-09-16 07:28:32', 1, 0, '[{id: 1,name: \'folder 1\'},{id: 2,name: \'filder 2\'}]', 1, 1, NULL, NULL),
	(18, 1, 'LongTest1', '-', '2021-09-18 09:36:15', '2021-09-18 09:36:15', 1, 0, NULL, 1, 1, NULL, NULL),
	(19, 1, 'Long   Test1', '-', '2021-09-18 09:57:30', '2021-09-18 09:57:30', 1, 0, NULL, 1, 1, NULL, NULL),
	(20, 1, 'LongTest1', '-', '2021-09-21 04:14:26', '2021-09-21 04:14:26', 1, 19, '[]', 1, 1, NULL, NULL),
	(21, 1, 'LongTest1', '-', '2021-09-21 04:17:56', '2021-09-21 04:17:56', 1, 18, '[]', 1, 1, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `jobs` (
  ...
  `path` text COLLATE utf8mb4_unicode_ci,
  `file_jobs_thumbnail` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table zimfiles.jobs: ~8 rows (approximately)
DELETE FROM `jobs`;
/*!40000 ALTER TABLE `jobs` DISABLE KEYS */;
INSERT INTO `jobs` (`id`, `user_id`, `director_id`, `file_id`, `file_jobs`, `status`, `time_upload`, `time_confirm`, `time_done`, `type`, `created_at`, `updated_at`, `editor_assign`, `path`, `file_jobs_thumbnail`) VALUES
	(1, 1, 7, NULL, 'testJobsFile.txt', 2, '2021-09-06 02:19:49', '2021-09-06 02:19:49', NULL, 1, '2021-08-28 08:17:08', '2021-09-06 02:19:49', 5, NULL, NULL),
	(2, 1, 15, 9, 'cham cong.txt', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 1, '2021-09-03 13:44:20', '2021-10-05 09:11:33', 5, NULL, NULL),
	(3, 1, 15, NULL, 'cham cong.txt', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 1, '2021-09-03 13:46:29', '2021-10-05 09:11:33', 5, NULL, NULL),
	(4, 1, 15, NULL, 'ava.jpg', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 1, '2021-09-03 13:46:29', '2021-10-05 09:11:33', 5, NULL, NULL),
	(5, 1, 15, NULL, 'document.txt', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 0, '2021-09-27 04:30:04', '2021-10-05 09:11:33', 5, NULL, NULL),
	(6, 1, 15, NULL, 'document.txt', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 0, '2021-09-27 04:33:26', '2021-10-05 09:11:33', 5, NULL, NULL),
	(7, 1, 15, NULL, 'test_ava.png', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 0, '2021-09-29 08:39:27', '2021-10-05 09:11:33', 5, NULL, '/disk1/DATA/LongNguyen3/dir_03092021/expert/test_ava.png'),
	(8, 1, 15, NULL, 'test_ava.png', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 0, '2021-09-29 09:20:23', '2021-10-05 09:11:33', 5, NULL, '/disk1/DATA/LongNguyen3/dir_03092021/expert/test_ava.png'),
	(9, 1, 15, NULL, 'ava_coppy.jpg', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 0, '2021-09-29 09:34:08', '2021-10-05 09:11:33', 5, NULL, 'app/dba36a14509618dafa965e451b99b2d21.png'),
	(10, 1, 15, NULL, 'ava_coppy.jpg', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 0, '2021-09-29 09:44:11', '2021-10-05 09:11:33', 5, NULL, 'app/a2766bd3e1bfe91ab09a19c5c739e70d1.png'),
	(11, 1, 15, NULL, '_DSC4823.nef', 3, '2021-10-05 09:11:33', '2021-10-05 09:11:33', NULL, 0, '2021-10-02 14:57:42', '2021-10-05 09:11:33', 5, NULL, NULL);
...
-- Dumping data for table zimfiles.migrations: ~11 rows (approximately)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(18, '2021_09_04_080553_add_jobs_table', 5),
	(20, '2021_09_16_072239_add_column_path_job', 6),
	(21, '2021_09_21_040947_add_type_dir', 7);
...
INSERT INTO `oauth_access_tokens` (`id`, `user_id`, `client_id`, `name`, `scopes`, `revoked`, `created_at`, `updated_at`, `expires_at`) VALUES
	...
	('b1cd1d69777b75523d0f1bc2516a072cf0d2c6275173f6e77e722df495a76814fe5df6b94ca0a57a', 2, '93d7fed2-c1fa-4477-b1ab-9da663d45c72', 'admin@gmail.com_2', '[]', 0, '2021-09-14 07:07:39', '2021-09-14 07:07:39', '2022-09-14 07:07:39'),
