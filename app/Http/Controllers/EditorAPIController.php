...
class EditorAPIController extends Controller
{
    ...
    public function getJob(Request $request)
    {
        ...
        if (!empty($checkJobsRejected)) {
            ...
            $checkJobsRejected->path_job_online = str_replace('disk1/DATA/','', config('const.public_nas_address') . $jobPath);
        ...
        if ($checkJobs != null) {
            ...
            $checkJobs->path_job_online = str_replace('disk1/DATA/','', config('const.public_nas_address') . $jobPath);
        ...
        $dir->path_job_online = str_replace('disk1/DATA/','', config('const.public_nas_address') . $jobPath);
