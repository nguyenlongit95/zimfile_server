                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="/admin/customers/edit/{{$customer->id}}" class="btn-warning padding510510">Update</a></td>
                            <td class="text-center"><a href="/admin/customers/delete/{{$customer->id}}" class="btn-danger padding510510">Delete</a></td>
                        </tr>
                        @endforeach
                        </tfoot>
                    </table>
